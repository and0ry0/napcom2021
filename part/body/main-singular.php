...
<div class="">
  ...
  <main class="mx-auto px-4 650:px-0 w-screen 650:w-650 1000:w-960">
    ...
    <div class="flex flex-col 1000:flex-row">
      <article class="overflow-hidden 650:mx-auto relative text-lg w-auto 650:w-650 my-8 leading-8" id="<?php the_ID(); ?>">
        ...
        <!-- <div class="l-single__block c-recommend sense">
<h2>この記事を読んだ人は、こんな記事も読んでいます</h2>
        ...
        <!-- <div id="before-comment-sense" class="sense l_single__center">
